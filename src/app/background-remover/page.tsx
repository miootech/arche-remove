...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://arche-remove.pages.dev/background-remover"
    }
  ]
};
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              arche.remove ist ein kostenloser KI Hintergrund Entferner, der vollständig in deinem Browser läuft. Kein Upload, keine Anmeldung, unbegrenzte Nutzung. Das KI-Modell (ISNet) läuft lokal über WebAssembly, WebGL oder WebGPU – deine Bilder verlassen zu keinem Zeitpunkt dein Gerät.
            </p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">Warum ein kostenloser Hintergrund Entferner?</h2>
            <p className="text-muted-foreground leading-relaxed">
              remove.bg ist der bekannteste Online-Hintergrund-Entferner, aber der kostenlose Plan ist stark limitiert: maximal ein paar Bilder pro Monat, Wasserzeichen auf dem Ergebnis, Bildauflösung auf 0,25 Megapixel begrenzt, und alle Bilder werden zum Server hochgeladen. Wer mehr will, zahlt schnell $24.99/Monat für die Pro-Version.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              arche.remove schließt diese Lücke. Es ist eine komplett kostenlose Alternative, die alle Features bietet: unbegrenzte Nutzung, Originalauflösung, kein Wasserzeichen, kein Upload. Das KI-Modell läuft über WebAssembly, WebGL oder WebGPU direkt auf deiner Hardware. Deine Bilder bleiben zu 100% auf deinem Gerät.
            </p>
          </section>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">So entfernst du einen Hintergrund</h2>
            <p className="text-muted-foreground leading-relaxed">
              Die Hintergrund-Entfernung mit arche.remove dauert wenige Sekunden. Du brauchst keine Anmeldung und kannst sofort loslegen.
            </p>
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Öffne <a href="https://arche-remove.pages.dev/" className="text-amber-accent hover:underline">arche.remove</a> im Browser</li><li>Lade dein Bild hoch (Drag & Drop oder Datei-Auswahl)</li><li>Warte auf „Preparing AI…“ – das Modell wird einmalig geladen</li><li>Die KI entfernt automatisch den Hintergrund in Sekunden</li><li>Vergleiche Original und Ergebnis mit dem Schieberegler</li><li>Lade als transparente PNG oder WebP herunter</li>
            </ol>
          </section>
          ...
          <div className="flex flex-wrap gap-3 text-sm pb-8"><a href="https://arche-remove.pages.dev/remove-background-from-png" className="text-amber-accent hover:underline">PNG Hintergrund entfernen</a> <span className="text-muted-foreground">·</span> <a href="https://arche-remove.pages.dev/remove-background-from-jpg" className="text-amber-accent hover:underline">JPG Hintergrund entfernen</a> <span className="text-muted-foreground">·</span> <a href="https://arche-remove.pages.dev/transparent-background" className="text-amber-accent hover:underline">Transparenter Hintergrund</a> <span className="text-muted-foreground">·</span> <a href="https://arche-remove.pages.dev/faq" className="text-amber-accent hover:underline">FAQ</a></div>
        </main>
      </div>
