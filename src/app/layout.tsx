...
// ---------------------------------------------------------------------------
// SEO METADATA — arche.remove
// All claims are truthful: 100% client-side, free, unlimited, no account,
...
// All properties are truthful — no fabricated ratings, reviews, or download
// counts. Pricing is "free" with no limits (factually accurate).
// ---------------------------------------------------------------------------
const jsonLd = {
