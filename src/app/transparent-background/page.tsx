...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://arche-remove.pages.dev/transparent-background"
    }
  ]
};
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Mache den Hintergrund jedes Bildes transparent – kostenlos mit KI. Export als transparente PNG- oder WebP-Datei in Originalauflösung. 100% im Browser, ohne Upload, ohne Anmeldung. Das KI-Modell (ISNet) läuft vollständig lokal.
            </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Transparente Hintergründe brauchst du überall dort, wo Motive frei platziert werden sollen: Logos auf Webseiten, Produktfotos in Online-Shops, Profilebilder, Avatare, Präsentations-Grafiken, Social-Media-Posts mit freigestellten Motiven. Statt mühsames manuelles Freistellen in Photoshop oder GIMP erledigt die KI von arche.remove das in Sekunden, vollautomatisch und kostenlos.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Statt remove.bg zu nutzen (limitierter Free-Plan, Wasserzeichen, Auflösungs-Cap, Bilder-Upload zum Server) kannst du mit arche.remove unbegrenzt viele Bilder in Originalauflösung freistellen. Das KI-Modell läuft lokal, deine Bilder verlassen nie dein Gerät. Ideal für Designer, Shop-Betreiber und Social-Media-Manager.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-border"><tr><td className="py-3 px-4">Kostenlos</td><td className="text-center py-3 px-4 text-success">Unbegrenzt</td><td className="text-center py-3 px-4 text-destructive">Limitiert</td></tr><tr><td className="py-3 px-4">Upload nötig</td><td className="text-center py-3 px-4 text-foreground">Nein – lokal</td><td className="text-center py-3 px-4 text-muted-foreground">Ja – Server</td></tr><tr><td className="py-3 px-4">Auflösung</td><td className="text-center py-3 px-4 text-foreground">Original</td><td className="text-center py-3 px-4 text-muted-foreground">0,25 MP</td></tr><tr><td className="py-3 px-4">Wasserzeichen</td><td className="text-center py-3 px-4 text-success">Keins</td><td className="text-center py-3 px-4 text-muted-foreground">Ja</td></tr><tr><td className="py-3 px-4">Export-Formate</td><td className="text-center py-3 px-4 text-foreground">PNG, WebP</td><td className="text-center py-3 px-4 text-muted-foreground">PNG</td></tr><tr><td className="py-3 px-4">Datenschutz</td><td className="text-center py-3 px-4 text-success">100% client-side</td><td className="text-center py-3 px-4 text-destructive">Server-basiert</td></tr><tr><td className="py-3 px-4">Preis</td><td className="text-center py-3 px-4 text-success">Kostenlos</td><td className="text-center py-3 px-4 text-muted-foreground">Free / Pro $24.99/mo</td></tr></tbody>
              </table>
            </div>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">So machst du einen Hintergrund transparent</h2>
            <p className="text-muted-foreground leading-relaxed">
              Die transparente Hintergrund-Erstellung mit arche.remove dauert wenige Sekunden. Du brauchst keine Anmeldung und kannst sofort loslegen.
            </p>
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Öffne <a href="https://arche-remove.pages.dev/" className="text-amber-accent hover:underline">arche.remove</a> im Browser</li><li>Lade dein Bild hoch (PNG, JPG, WebP, GIF, BMP oder AVIF)</li><li>Die KI entfernt automatisch den Hintergrund in Sekunden</li><li>Vergleiche Original und Ergebnis mit dem Schieberegler</li><li>Lade als transparente PNG oder WebP herunter</li>
            </ol>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold tracking-tight">Features von arche.remove für Transparenz</h2>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              arche.remove lädt deine Bilder niemals auf einen Server. Das KI-Modell (ISNet) läuft vollständig lokal in deinem Browser über WebAssembly, WebGL oder WebGPU. Keine Server-Datenbank, kein Tracking deiner Bildinhalte, keine Daten, die missbraucht werden können.
            </p>
          </section>
          ...
          <div className="flex flex-wrap gap-3 text-sm pb-8"><a href="https://arche-remove.pages.dev/background-remover" className="text-amber-accent hover:underline">Hintergrund Entferner</a> <span className="text-muted-foreground">·</span> <a href="https://arche-remove.pages.dev/remove-background-from-png" className="text-amber-accent hover:underline">PNG Hintergrund entfernen</a> <span className="text-muted-foreground">·</span> <a href="https://arche-remove.pages.dev/remove-background-from-jpg" className="text-amber-accent hover:underline">JPG Hintergrund entfernen</a> <span className="text-muted-foreground">·</span> <a href="https://arche-remove.pages.dev/faq" className="text-amber-accent hover:underline">FAQ</a></div>
        </main>
      </div>
